            ...
            <div class="row">
                <div class="col text-center">
                    <ul class="breadcrumb d-flex justify-content-center text-4-5 font-weight-medium mb-2">
                        ...
                        <li class="text-color-primary active">{{ $product ? $product->urlAlias : '' }}</li>
                    </ul>
                    <h1 class="text-color-light font-weight-bold text-10">{{ $product ? $product->productName : '' }}</h1>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container pt-3 pb-4">
            <div class="row mb-6 pb-3 justify-content-md-center">
                <div class="col-md-10" data-jplist-item="">
                    ...
                    "></div>
                            <h4 class="card-title mb-1 text-4 font-weight-bold text-center productName" style="padding: 10px !important;">{{ $product ? $product->productName : '' }}</h4>

                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <p style="text-decoration: underline;font-weight: bold;font-size: 14px;">Pardon the interruption!</p> Product description and information for {{ $product ? $product->productName : '' }} coming soon!
                                    <br><br>
